...
class HoldingsDownloader:
    ...
    def _get_etf_from_schwab(self, etf_symbol):
        ...
        try:
            driver.get(url)
            show_sixty_items = driver.find_element("xpath", "//a[@perpage='60']")
        ...
        while current_page <= num_pages:
            ...
            next_button = driver.find_element("xpath","//li[@pagenumber='{}']".format(current_page))
        ...
        if self.log_mode:
            ...
            header_elt = driver.find_element("xpath","//div[@modulename='FirstGlance']")
